...
library(baseballr)
```
Load in a test dataframe (Rafael Devers 2019 season)
...
Create Launch Radial Chart Function (based off of Baseball Savant's Radial Chart). This function takes a dataframe in the format of the csv's downloadable from baseball savant or via teh scrape_statcast_savant function and creates a Radial Chart for the player.
